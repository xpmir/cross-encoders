...
if __name__ == "__main__":
    ...
    batch = DummyBatch.build(batch_size=8, query="What is AI?", document="AI stands for Artificial Intelligence.")
    results = benchmark_model(
        model_cls=HFCrossScorer.C,  # Replace with actual model class
        name="ExampleModel",
        batch=batch,
        device=device,
        model_name="cross-encoder/ms-marco-MiniLM-L-6-v2",  # Replace with actual model name
        warmup_steps=5,
        num_runs=20,
