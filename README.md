...
```
cd existing_repo
git remote add origin https://git.isir.upmc.fr/morand/sota-cross-encoders.git
git branch -M main
...
* [Set up project integrations](https://git.isir.upmc.fr/morand/sota-cross-encoders/-/settings/integrations)
